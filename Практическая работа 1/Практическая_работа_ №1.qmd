...
В результате лабораторной работы былы пройдены 4 урока по языку программирования R и разобраны базовые аспекты языка.

## Вывод

В результате выполнения работы были получены базовые навыки программирования на языке R.
