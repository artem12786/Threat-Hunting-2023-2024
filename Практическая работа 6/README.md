...
В ходе выполнения задания были улучшены навыки работы с языком
программирования R в контексте обработки данных.

## Вывод

Исследована структура журнала системы Windows Active Directory, и
приобретены дополнительные навыки в области основных методов обработки
данных с использованием экосистемы tidyverse в языке программирования R.
